...
export type RadioProps<T> = React.HTMLProps<HTMLInputElement> & BaseFormControlProps<T> & {
  value: T;
};

const RadioInner = React.forwardRef<HTMLInputElement, RadioProps<any>>((props, ref) => {
  const {
    control,
    onChange,
    value,
